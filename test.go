...
func makeUnitSubstitution(myarray []mapsWithDuplicate){
	...
	fmt.Println(deleteMultipleElementsTest(myarray,findUnitProductions(myarray)))
...
func deleteMultipleElementsTest(baseArray []mapsWithDuplicate, arrayToDelete []mapsWithDuplicate) []mapsWithDuplicate {
